...
import com.seojongcheol.androidnews.databinding.ItemNewsListBinding
import com.seojongcheol.androidnews.utils.TimeUtils
import com.seojongcheol.androidnews.webview.WebViewActivity

class ListNewsAdapter : ListAdapter<NewsItem, ListNewsAdapter.NewsViewHolder>(ArticleDiffCallback()) {
    ...
    inner class NewsViewHolder(private val binding: ItemNewsListBinding) : RecyclerView.ViewHolder(binding.root) {
